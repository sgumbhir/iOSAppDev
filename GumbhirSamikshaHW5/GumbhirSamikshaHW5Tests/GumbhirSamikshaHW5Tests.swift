...
import XCTest
@testable import GumbhirSamikshaHW5

final class GumbhirSamikshaHW5Tests: XCTestCase {
    ...
    func testInsertEnd() {
        myModel.insert(question: "Question", answer: "Answer", favorite: false)
...
//        XCTAssertEqual(value, 1)
    ...
    func testSingleton(){
        ...
        model1.insert(question: "Question", answer: "answer", favorite: false)
